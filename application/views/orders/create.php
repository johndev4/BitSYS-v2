          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="" class="col-sm-12 control-label text-right">Date: <?php echo date('Y-m-d') ?></label>
              </div>
              <div class="form-group">
              ...
              <table class="table table-bordered table-responsive" id="product_info_table">
                ...
                <tbody>
                  <tr id="row_1">
                    ...
                    <td><input type="number" name="qty[]" id="qty_1" class="form-control" style="width: 100px;" required oninput="getTotal(1)"></td>
                    <td>
                      <input type="number" name="rate[]" id="rate_1" class="form-control" style="width: 100px;" disabled autocomplete="off">
                      <input type="hidden" name="rate_value[]" id="rate_value_1" class="form-control" autocomplete="off">
                    </td>
                    <td>
                      <input type="number" name="amount[]" id="amount_1" class="form-control" style="width: 100px;" disabled autocomplete="off">
                      <input type="hidden" name="amount_value[]" id="amount_value_1" class="form-control" autocomplete="off">
                    </td>
                    <td><button type="button" class="btn btn-default" onclick="removeRow('1')"><i class="fa fa-times"></i></button></td>
                  </tr>
                </tbody>
              </table>
              <br /> <br />
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          html += '</select>' +
            ...
            '<td><button type="button" class="btn btn-default" onclick="removeRow(\'' + row_id + '\')"><i class="fas fa-times"></i></button></td>' +
            '</tr>';
